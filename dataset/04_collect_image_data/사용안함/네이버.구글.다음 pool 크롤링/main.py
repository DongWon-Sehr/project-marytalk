...
class Sites:
    ...
    def get_text(code):
        if code == Sites.GOOGLE:
            ...
            return 'naver'
        elif code == Sites.DAUM:
            return 'daum'       
        elif code == Sites.DAUM_FULL:
            return 'daum'
...
class AutoCrawler:
    def __init__(self, skip_already_exist=True, n_threads=9, do_google=True, do_naver=True,do_daum = True, download_path='download',
                 full_resolution=True, face=False):
        """
    ...
    def make_dir(dirname):
        # getcwd()함수: 현재 작업 디렉터리의 위치를 가져올 때 쓰입니다.
    ...
    def download_images(self, keyword, links, site_name):
        ...
        for index, link in enumerate(links):
            try:
                ...
                no_ext_path = '{}/{}/{}_{}_{}'.format(self.download_path, keyword, site_name, keyword, str(index).zfill(4))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--threads', type=int, default=9, help='Number of threads to download.')
    parser.add_argument('--google', type=str, default='true', help='Download from google.com (boolean)')
    parser.add_argument('--naver', type=str, default='true', help='Download from naver.com (boolean)')
    parser.add_argument('--daum', type=str, default='true', help='Download from daum.com (boolean)')
    ...
    _daum = False if str(args.daum).lower() == 'false' else True
