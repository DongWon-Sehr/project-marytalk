...
class AutoCrawler:
    def __init__(self, skip_already_exist=True, n_threads=2, do_google=True, do_naver=True, download_path='download',
    ...
    def download_images(self, keyword, links, site_name):
        self.make_dir('{}/{}/{}'.format(self.download_path, site_name, keyword))
        total = len(links)
        ...
        for index, link in enumerate(links):
            try:
                ...
                no_ext_path = '{}/{}/{}/{}_{}'.format(self.download_path, site_name, keyword, keyword,  str(index).zfill(4))
    ...
    def do_crawling(self):
        ...
        for keyword in keywords:
            dir_name = '{}/{}/{}'.format(self.download_path, keyword, keyword)
